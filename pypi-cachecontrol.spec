...
Source0  : https://files.pythonhosted.org/packages/d2/23/db12e0b6b241e33f77f7cce01a06b4cc6f8071728656cc0ea262d2a14dad/cachecontrol-0.14.1.tar.gz
...
%prep
%setup -q -n cachecontrol-0.14.1
cd %{_builddir}/cachecontrol-0.14.1
pushd ..
cp -a cachecontrol-0.14.1 buildavx2
popd
pushd ..
cp -a cachecontrol-0.14.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730823811
