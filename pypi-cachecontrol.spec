...
Source0  : https://files.pythonhosted.org/packages/9d/47/9bdf134012537324bbdebe84c144cc8fab08f148fc6c9ce89b8eefff1cb0/CacheControl-0.13.0.tar.gz
...
%prep
%setup -q -n CacheControl-0.13.0
cd %{_builddir}/CacheControl-0.13.0
pushd ..
cp -a CacheControl-0.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685636063
