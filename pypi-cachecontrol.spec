...
Source0  : https://files.pythonhosted.org/packages/06/55/edea9d90ee57ca54d34707607d15c20f72576b96cb9f3e7fc266cb06b426/cachecontrol-0.14.0.tar.gz
...
%prep
%setup -q -n cachecontrol-0.14.0
cd %{_builddir}/cachecontrol-0.14.0
pushd ..
cp -a cachecontrol-0.14.0 buildavx2
popd
pushd ..
cp -a cachecontrol-0.14.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730207366
