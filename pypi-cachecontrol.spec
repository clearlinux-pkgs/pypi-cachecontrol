...
Source0  : https://files.pythonhosted.org/packages/b7/a4/3390ac4dfa1773f661c8780368018230e8207ec4fd3800d2c0c3adee4456/cachecontrol-0.14.2.tar.gz
...
%prep
%setup -q -n cachecontrol-0.14.2
cd %{_builddir}/cachecontrol-0.14.2
pushd ..
cp -a cachecontrol-0.14.2 buildavx2
popd
pushd ..
cp -a cachecontrol-0.14.2 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736272180
